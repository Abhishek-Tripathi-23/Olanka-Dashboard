...
const TableRowFinance = React.memo(({ data }) => {
  return (
    <tr className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
      <td className="w-10 !w-10 2xl:w-60 p-2 sm:p-3 lg:p-4 xl:p-5 5xl:p-5 border-r border-gray-800" >
        <div className="w-12 h-12 2xl:w-40 flex justify-center items-center">
