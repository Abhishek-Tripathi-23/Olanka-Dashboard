...
const CommunicationTable = ({ data = TABLE_DATA, summaryData = SUMMARY_DATA }) => {
  ...
  return (
    <div className="bg-white w-full  xl:max-w-[550px] 2xl:max-w-[1400px]  px-4 py-2 lg:min-h-[1100px] lg:max-h-[1110px] xl:min-h-[753px] xl:max-h-[755px] 2xl:max-h-[1970px] rounded-2xl">
