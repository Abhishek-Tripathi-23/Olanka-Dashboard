...
const CommunicationTable = ({ data = TABLE_DATA, summaryData = SUMMARY_DATA }) => {
  ...
  return (
    <div className="bg-white w-full   2xl:max-w-[1400px]  px-4 py-2 max-h-[1220px] 2xl:max-h-[1970px] rounded-2xl">
      <div className="w-full border border-black rounded-2xl mt-2 overflow-x-auto">
        <table className="bg-white rounded-2xl shadow-lg w-full min-w-[680px]" role="table" aria-label="Communication metrics table">
          <TableHeader />
          <tbody>
