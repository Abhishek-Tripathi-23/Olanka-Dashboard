  ...
  return (
    <tr className="bg-[#C4C4C4] font-bold border-t border-gray-800">
      ...
      {COLUMNS_FINANCE.map((column, index) => {
          ...
          return (
            <td key={column.key} className={isLast ? "w-20 relative text-xs sm:text-sm lg:text-base h-full" : "w-20 border-r border-gray-800 relative text-xs sm:text-sm lg:text-base h-full"}>
              <div className="h-full flex justify-center items-center">
                <div className="bg-green-500 text-white h-full w-full flex justify-center items-center font-bold text-sm sm:text-xl 2xl:text-3xl">
                  {data.totalPaid}
                </div>
              </div>
            </td>
        ...
        return (
          <td key={column.key} className={isLast ? "w-16 relative text-xs sm:text-sm lg:text-base h-full" : "w-16 border-r border-gray-800 relative text-xs sm:text-sm lg:text-base h-full"}>
            <div className="grid grid-cols-2 gap-0 text-center text-xs sm:text-sm lg:text-base h-full">
              ...
              {(column.key === "followUp" || column.key === "he" || column.key === "paid") ? (
                <>
                  ...
                  <div className="text-center font-semibold text-xs sm:text-sm lg:text-base h-full flex justify-center items-center relative">
                    {column.key === "followUp" && data.summaryIndicators.followUp && (
                      <span className="bg-black text-white w-6 h-6 sm:w-7 sm:h-7 xl:w-8 xl:h-8 2xl:h-16 2xl:w-16 2xl:text-4xl rounded-full flex items-center justify-center text-xs sm:text-sm xl:text-lg font-bold">
                        {data.summaryIndicators.followUp.top}
                      </span>
                    )}
                    {column.key === "he" && data.summaryIndicators.he && (
                      <span className="bg-blue-500 text-white w-6 h-6 sm:w-7 sm:h-7 xl:w-8 xl:h-8 2xl:h-16 2xl:w-16 2xl:text-4xl rounded-full flex items-center justify-center text-xs sm:text-sm xl:text-lg font-bold">
                        {data.summaryIndicators.he.top}
                      </span>
                    )}
                    {column.key === "paid" && data.summaryIndicators.paid && (
                      <span className="bg-green-500 text-white w-6 h-6 sm:w-7 sm:h-7 xl:w-8 xl:h-8 2xl:h-16 2xl:w-16 2xl:text-4xl rounded-full flex items-center justify-center text-xs sm:text-sm xl:text-lg font-bold">
                ...
                <>
                  ...
                  <div className="text-center font-semibold text-xs sm:text-sm lg:text-base h-full 2xl:text-4xl flex justify-center items-center">{totals[0]}</div>
                  <div className={`text-center font-semibold text-xs sm:text-sm lg:text-base bg-[#AFAFAF] h-full 2xl:text-4xl flex justify-center items-center`}>{totals[1]}</div>
                  <div className="text-center text-black text-xs sm:text-sm lg:text-base h-full 2xl:text-4xl border-t border-t-gray-400 flex justify-center items-center">{totals[2]}</div>
                  <div className={`text-center text-black text-xs sm:text-sm lg:text-base bg-[#AFAFAF] h-full 2xl:text-4xl border-t border-t-gray-400 flex justify-center items-center`}>{totals[3]}</div>
                </>
              )}
            </div>
          </td>
